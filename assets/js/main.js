...
const GZ_ICONS = {
  ...
  medal: '<path d="M8.5 2h7l2.7 6.3-5 2.3-2.2-1-2.2 1-5-2.3L8.5 2zM12 11a5.5 5.5 0 110 11 5.5 5.5 0 010-11zm0 2.6l-.9 1.8-2 .3 1.4 1.4-.3 2 1.8-1 1.8 1-.3-2 1.4-1.4-2-.3-.9-1.8z"/>',
  gamepad: '<path d="M7.5 6C4.5 6 2 8.5 2 11.7c0 1.9.9 3.6 2.4 4.6.6.4 1.4.4 1.9-.1l2.4-2.4c.4-.4 1-.7 1.6-.7h3.4c.6 0 1.2.3 1.6.7l2.4 2.4c.5.5 1.3.5 1.9.1A5.7 5.7 0 0022 11.7C22 8.5 19.5 6 16.5 6h-9zM8 9.5h1.5V11H11v1.5H9.5V14H8v-1.5H6.5V11H8V9.5zM16 9.8a1.1 1.1 0 110 2.2 1.1 1.1 0 010-2.2zm2.3 2.3a1.1 1.1 0 110 2.2 1.1 1.1 0 010-2.2z"/>',
