...
(function () {
  ...
  // ("5.0 rating · 112 Google reviews") is refreshed daily against the
  // live Google Business Profile count (still 5.0, now 112 total reviews
  // as of 2026-09-18, up from 111) -- this written pool is NOT re-scraped
  ...
  // and the real total will keep growing over time (50 unwritten/other
